...
class IdPhotoService {
  Future<IdPhotoResult> createPassportPhoto({
    ...
    // 3. Apply Background Color Fill if not white/transparent
    final canvasPhoto = img.Image(width: preset.targetWidthPx, height: preset.targetHeightPx);
    final bgRgb = img.ColorRgb8(bgColor.r.round(), bgColor.g.round(), bgColor.b.round());
