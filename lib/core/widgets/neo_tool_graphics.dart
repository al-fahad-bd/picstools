...
class BgRemoverToolGraphic extends StatelessWidget {
  final bool isDark;
  const BgRemoverToolGraphic({super.key, required this.isDark});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Eraser Magic Wand Graphic Frame
        Container(
          width: 82,
          height: 44,
          decoration: NeoStyles.neoDecoration(
            backgroundColor: isDark ? const Color(0xFF251A30) : NeoColors.softPurple,
            radius: 10,
            shadow: 2,
          ),
          child: Row(
