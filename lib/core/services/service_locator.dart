...
Future<void> initServiceLocator() async {
  ...
  getIt.registerLazySingleton<FileSaveService>(
    () => FileSaveServiceImpl(getIt<AdService>()),
  );
  getIt.registerLazySingleton<FileShareService>(
    () => FileShareServiceImpl(getIt<AdService>()),
  );
  ...
  final adService = AdServiceImpl(iapService);
